...
@RestController
@RequestMapping("/admin/data-room")
public class DataRoomAdminController extends BasePostAdminController {

    public DataRoomAdminController(PostService postService) {
        super(postService);
    }
